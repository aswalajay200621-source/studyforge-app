...
import { Mail, Lock, Eye, EyeOff, Zap, ArrowRight, Code, User } from "lucide-react";
      ...
      <div className="hidden lg:flex w-1/2 relative bg-gradient-to-br from-indigo-900 to-violet-900 text-white items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 p-16 max-w-xl">
          ...
          <h1 className="text-5xl font-bold leading-tight mb-6" style={{ fontFamily: "var(--font-outfit)" }}>
            Start Your Journey.<br />Unlock Potential.
          </h1>
          <p className="text-lg text-indigo-100/80 leading-relaxed">
            Join thousands of students using AI to generate notes, flashcards, and quizzes from their study materials.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 overflow-y-auto">
        ...
        >
          ...
          <form className="space-y-4" onSubmit={handleSignup}>
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <User className="h-5 w-5" style={{ color: "var(--foreground-muted)" }} />
                </div>
                <input 
                  type="text" 
            ...
            <div className="flex items-start mt-4">
              <div className="flex items-center h-5">
                <input type="checkbox" id="terms" className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 mt-1" />
              </div>
              <label htmlFor="terms" className="ml-2 text-sm leading-snug" style={{ color: "var(--foreground-secondary)" }}>
                I agree to the <a href="#" className="hover:underline text-[var(--forge-indigo)]">Terms of Service</a> and <a href="#" className="hover:underline text-[var(--forge-indigo)]">Privacy Policy</a>.
              </label>
            </div>

            <button 
              className="w-full py-3 px-4 rounded-xl text-white font-semibold flex items-center justify-center gap-2 bg-gradient-to-r from-indigo-500 to-violet-600 hover:opacity-90 shadow-md transition-opacity mt-4"
            >
          ...
          <p className="mt-8 text-center text-sm" style={{ color: "var(--foreground-secondary)" }}>
            ...
            <Link href="/login" className="font-semibold hover:underline" style={{ color: "var(--forge-indigo)" }}>
              Sign in
            </Link>
          </p>
        </motion.div>
